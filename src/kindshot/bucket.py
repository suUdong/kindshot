...
IGNORE_KEYWORDS: list[str] = [
    ...
    # 간담회/포럼 (행사 안내)
    "간담회",
    # 실적 공정공시 (의무 보고 — 방향성 불명)
    "잠정)실적(공정공시)", "연결재무제표기준영업",
    # 주총 결과 (행정 완료)
    "주주총회결과",
    # 특징주/테마 묶음 기사 (개별 촉매 아님)
    "[특징주]",
    # CB/BW 콜옵션 행사 (행정적 전환)
    "콜옵션 행사",
    # 펀드 출시 (개별 종목 시그널 아님)
...
POS_WEAK_KEYWORDS: list[str] = [
    ...
    "매출 기록", "매출 달성",
    "해외매출", "해외 매출",
    # 학회 발표 (AACR, ASCO 등 바이오 학회)
    "AACR", "ASCO",
    "전임상 결과 발표", "전임상 데이터 발표", "전임상 데이터 공개",
    "포스터 발표",
    # 매출/출하 본격화
    "매출 본격화", "출하 확대", "출하 본격화",
    "수출 확대",
    # 국제 표준/인증
    "국제표준 승인", "국제 표준 승인", "글로벌 표준 승인",
    # 강세 (시장 반응 보도)
    "강세", "급등",
    # 투자/설비 공시
    "신규시설투자", "신규 시설투자",
